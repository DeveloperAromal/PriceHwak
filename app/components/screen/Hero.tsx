            ...
            <div className="top">
             ...
             <section className="top">
                <div className="top text-center pt-6 pb-5">
                    <h1 className="mt-5 text-4xl lg:text-7xl md:text-5xl sm:text-4xl">Your Money's Important</h1>
                    <h3 className="mt-4 text-3xl lg:text-6xl md:text-4xl sm:text-3xl" style={{ fontFamily: "Dancing Script" }}>so don't waste time</h3>
